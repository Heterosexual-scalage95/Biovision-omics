...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        default="outputs/morphology_cell_families_fov_split",
    )
    ...
    family_counts = (
        frame["cell_family"]
        .value_counts()
        .rename_axis("cell_family")
        .reset_index(name="cell_count")
    )
    family_counts.to_csv(
        output_dir / "cell_family_counts.csv",
        index=False,
    )
    ...
    summary = {
        ...
        "cell_families": sorted(labels.unique()),
